...
"""
Fit the real-valued neural network to the full-duplex training set.
"""
...
from gen_models import gen_ffnn
from helpers.preprocess import basic_parser, set_seeds
from helpers.flop import flop_realnn
...
def train(params, batch_size, learning_rate, x_train, x_test, y_train, y_test, seed):
    """Training loop for the real-valued feed-forward neural-network.
    """
    ...
    model = gen_ffnn(params, learning_rate)
