...
# -*- coding: utf-8 -*-
"""
Fit the complex-valued recurrent neural network to the full-duplex training set.
"""
...
from gen_models import gen_complex_rnn
...
from helpers.flop import flop_complexrnn
...
def main(params):
    ...
    shared_params = ("complex_rnn", "nn", params, gen_complex_rnn, flop_complexrnn)
